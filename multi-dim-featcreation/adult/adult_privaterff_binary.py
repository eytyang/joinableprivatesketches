...
if __name__ == "__main__":
	...
	sketch_dim = [50, 100, 150, 200, 250]
	total_eps_list = [5.0, 10.0, 15.0, 20.0, 25.0]
	...
	for dim in sketch_dim:
		...
		for trial in range(num_trials):
			...
			for total_eps in total_eps_list:
				...
				dp_join = DP_Join(eps_memb, eps_val)
	...
	for alg in algs:
		...
		file = 'adult_rffbinary_%s_limit_trials=%i' % (alg.lower(), num_trials)
