...
if __name__ == "__main__":
	...
	subsample9_train = all_train[all_train['label'] == 9].sample(n = int(all_train[all_train['label'] == 9] / 5))
	...
	subsample9_test = all_test[all_test['label'] == 9].sample(n = int(all_test[all_test['label'] == 9] / 5))
