...
if __name__ == "__main__":
	...
	subsample9_train = all_train[all_train['label'] == 9].sample(n = int(len(all_train[all_train['label'] == 9]) / 4))
	...
	subsample9_test = all_test[all_test['label'] == 9].sample(n = int(len(all_test[all_test['label'] == 9]) / 4))
	...
	for alg in algs:
		...
		file = 'mnist49joinperfectmemb_pca_smalleps_%s_trials=%i' % (alg.lower(), num_trials)
