...
if __name__ == "__main__":
	...
	for dim in sketch_dim:
		...
		for trial in range(num_trials):
			...
			for alg in algs:
				trial_dict[alg].append(get_loss(f_train_rff, l_train, f_test_rff, l_test))
	...
	for alg in algs:
		...
		file = 'covtype_noprivacy_nopca_%s_trials=%i' % (alg.lower(), num_trials)
